...
cas de problème, en appuyant sur un bouton contenu dans le bracelet.
Le système contenu dans le bracelet envoie des signaux Bluetooth aux balises
...
zone couverte par la géolocalisation, ainsi que d'afficher la photo de la personne appelant à l'aide.
////
